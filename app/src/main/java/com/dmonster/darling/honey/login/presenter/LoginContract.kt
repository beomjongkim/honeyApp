...
interface LoginContract {
    ...
    interface View: BaseView {
        fun setLoginComplete(loginId: String?, mbNo: String?, recommend: String?, gender: String?, dormantState: String?, profileState: String?)    // 로그인

        fun setLoginFailed(error: String?)    // 로그인 호출실패

        fun setSocialLoginComplete(loginId: String?, mbNo: String?, recommend: String?, gender: String?, dormantState: String?, profileState: String?)    // 소셜 로그인
