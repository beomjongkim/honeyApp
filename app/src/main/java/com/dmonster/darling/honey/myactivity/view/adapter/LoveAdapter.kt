...
class LoveAdapter(val context: Context?): androidx.recyclerview.widget.RecyclerView.Adapter<LoveAdapter.ViewHolder>() {
    ...
    class ViewHolder(var view: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(view) {
        ...
        var talkBtn: Button = view.findViewById(R.id.btn_item_new_member_talk)
    }
